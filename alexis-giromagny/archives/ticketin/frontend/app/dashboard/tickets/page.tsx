...
function TicketsView() {
  ...
  const initialStatus = (searchParams.get("status") as TicketStatus | null) ?? "all";
  const unassignedScope = searchParams.get("assignee") === "none";
  ...
  const scoped = useMemo(
    () => (unassignedScope ? tickets.filter((t) => !t.assigned_to_id) : tickets),
    [tickets, unassignedScope]
  );
